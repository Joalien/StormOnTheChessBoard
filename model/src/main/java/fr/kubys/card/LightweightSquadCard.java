...
public class LightweightSquadCard extends Card<LightweightSquadCard.LightweightSquadCardParam> {

    public record LightweightSquadCardParam(Pawn pawn1, Pawn pawn2) {}
