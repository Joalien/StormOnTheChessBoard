...
# Idempotent setup for Raspberry Pi 5 (Debian/Raspberry Pi OS)
# Run as a user with sudo privileges on kubys.fr
# Usage: ssh <initial-user>@kubys.fr 'bash -s' < scripts/setup.sh

SOTC_USER="sotc"
REPO_URL="https://github.com/Joalien/StormOnTheChessBoard.git"
APP_DIR="/home/${SOTC_USER}/app"

echo "=== Storm On The Chess Board - Pi Setup ==="
